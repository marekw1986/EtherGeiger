...
#define MY_DEFAULT_MAC_BYTE3            (0x05)	// PIC32MX6XX/7XX internal Ethernet 
#define MY_DEFAULT_MAC_BYTE4            (0x16)	// controller and wish to use the 
#define MY_DEFAULT_MAC_BYTE5            (0x17)	// internal factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x54)	// address instead.

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (92ul)
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(2048ul)
	#define TCP_PIC_RAM_SIZE					(6144ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] = 
		{
            ...
            {TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 512, 512},
            {TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 512, 512},
			{TCP_PURPOSE_DEFAULT, TCP_PIC_RAM, 1024, 1024},
...
// -- SNTP options -------------------------------------------------------
    //SNTP client is used to update internal RTCC module of PIC32 MCU
    #define SNTP_UPDATE_RTCC
